        ...
        self.update_tables_function = """
            CREATE OR REPLACE FUNCTION update_tables(chats_list JSON, chats_tables_list JSON) RETURNS bool AS $$
                ...
                BEGIN                    
                    ...
                    FOR rec IN SELECT json_populate_recordset.chat_id, json_populate_recordset.users_json FROM json_populate_recordset(null::chats_tables_list_type, chats_tables_list)
                    LOOP
